        ...
        <form action="procesarSeleccion.jsp" method="post">
            <div class="accordion" id="accordionCurso">
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseVideos" class="accordion-collapse collapse show" aria-labelledby="headingVideos" data-bs-parent="#accordionCurso">
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseAudios" class="accordion-collapse collapse" aria-labelledby="headingAudios" data-bs-parent="#accordionCurso">
                        <div class="accordion-body">
                ...
                <!-- Archivos relacionados al curso -->
                <div class="accordion-item">
                    ...
                    <div id="collapseArchivos" class="accordion-collapse collapse" aria-labelledby="headingArchivos" data-bs-parent="#accordionCurso">
                        <div class="accordion-body">
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseCF" class="accordion-collapse collapse" aria-labelledby="headingCF" data-bs-parent="#accordionCurso">
                        <div class="accordion-body">
