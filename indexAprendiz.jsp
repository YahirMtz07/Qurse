        ...
        <div class="Header">
            ...
            <div style="background-color:#FFD56A;  width: 300px; margin: 0px; " class="offcanvas offcanvas-start" tabindex="-9" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
                ...
                <div class="offcanvas-body"  style=" padding: 0px; margin: 0px;">
                    ...
                    <div class="boton-menu" onclick="window.location.href = 'indexAprendiz.jsp'">
                        <div>Pagina Principal</div>
                    </div>
                    <div class="boton-menu" onclick="window.location.href = 'indexAprendiz.jsp'">
                        <div>Buscador de Cursos</div>
                    </div>
                    <div class="boton-menu" onclick="window.location.href = 'MisCursosAprendiz.jsp'">
                        <div>Mis Cursos</div>
                    </div>
                    <div class="boton-menu" onclick="window.location.href = 'indexAprendiz.jsp'">
        ...
        <div class="container-fluid">
            ...
            <nav>          
                ...
                <div class="categorias">
                    <div class="categoria" onclick="window.location.href = 'indexAprendiz.jsp'"><div>Todos</div></div>
                    <div class="categoria" onclick="window.location.href = 'indexAprendiz.jsp'"><div>Tecnología y Programación</div></div>
                    <div class="categoria" onclick="window.location.href = 'indexAprendiz.jsp'"><div>Ciencias y Matemáticas</div></div>
                    <div class="categoria" onclick="window.location.href = 'indexAprendiz.jsp'"><div>Negocios y Emprendimiento</div></div>
                    <div class="categoria" onclick="window.location.href = 'indexAprendiz.jsp'"><div>Idiomas</div></div>
                    <div class="categoria" onclick="window.location.href = 'indexAprendiz.jsp'"><div>Artes y Creatividad</div></div>
                    <div class="categoria" onclick="window.location.href = 'indexAprendiz.jsp'"><div>Salud y Bienestar</div></div>
                    <div class="categoria" onclick="window.location.href = 'indexAprendiz.jsp'"><div>Ciencias Sociales y Humanidades</div></div>
                    <div class="categoria" onclick="window.location.href = 'indexAprendiz.jsp'"><div>Desarrollo Personal y Habilidades Blandas</div></div>
                    <div class="categoria" onclick="window.location.href = 'indexAprendiz.jsp'"><div>Marketing y Publicidad</div></div>
                    <div class="categoria" onclick="window.location.href = 'indexAprendiz.jsp'"><div>Finanzas y Contabilidad</div></div>
                    <div class="categoria" onclick="window.location.href = 'indexAprendiz.jsp'"><div>Ciencias de Datos e Inteligencia Artificial</div></div>
                    <div class="categoria" onclick="window.location.href = 'indexAprendiz.jsp'"><div>Diseño y Multimedia</div></div>
                    <div class="categoria" onclick="window.location.href = 'indexAprendiz.jsp'"><div>Negocios y Emprendimiento Digital</div></div>
                    <div class="categoria" onclick="window.location.href = 'indexAprendiz.jsp'"><div>Diseño Web y UX/UI</div></div>
                    <div class="categoria" onclick="window.location.href = 'indexAprendiz.jsp'"><div>Arte Digital e Ilustración</div></div>
                    <div class="categoria" onclick="window.location.href = 'indexAprendiz.jsp'"><div>Deportes y Entrenamiento Físico</div></div>
                    <div class="categoria" onclick="window.location.href = 'indexAprendiz.jsp'"><div>Música y Producción Musical</div></div>
                    <div class="categoria" onclick="window.location.href = 'indexAprendiz.jsp'"><div>Gastronomía y Hospitalidad</div></div>
                ...
                <%
                    ...
                    try {
                        ...
                        String query = "SELECT c.idCurso, c.nombreCurso, c.descripcion, c.categoria, p.image "
                                ...
                                + "LEFT JOIN portadasCursos p ON c.idCurso = p.idCurso where c.publico='si'";
                        ...
                        while (rs.next()) {
                            ...
                            String cursoUrl = "inscripcionCurso.jsp?idCurso=" + idCurso + "&linkCurso=" + java.net.URLEncoder.encode(nombreCurso, "UTF-8");
                            ...
                            if (isRightAligned) {
                                ...
                                out.println("<div class='prompt-extrabold' style='font-size: 35px; width:100%; justify-items: right; '><div style='background-color:#ED9F03; padding:6px; margin:5px; border-radius:15px; width:fit-content; margin-right:-1px;'>" + nombreCurso + "</div></div>");
                        ...
                        if (!hasCourses) {
                            ...
                            out.println("<p>No hay cursos disponibles por el momento.</p>");
                            out.println("</div>");
                        }
