...
<html>
    ...
    <body>
        <div class="Header">
            ...
            <%
                ...
                try {
                    ...
                    String query = "SELECT idLeccion, tituloLeccion, numLeccion, numPlantilla, nombreAudioLeccion, nombreVideoLeccion, nombreArchivoLeccion, nombreCFLeccion "
                            + "FROM lecciones WHERE idCurso = ? ORDER BY numLeccion;";
                    ...
                    if (!rs.isBeforeFirst()) {
                        // Si no hay lecciones en el resultado
                        out.println("<div class='no-lessons' style='text-align:center; font-size:20px; margin-top:20px;'>");
                        out.println("<p>Parece que el curso no tiene lecciones.</p>");
                        out.println("</div>");
                    } else {
                        // Mostrar las lecciones si existen
                        while (rs.next()) {
                            String idLeccion = rs.getString("idLeccion");
                            out.println("<div class='course'>");
                            out.println("<div class='bg-white rounded-lg shadow-md p-4'>");
                            out.println("<h3 class='text-xl font-bold'>Lección " + rs.getInt("numLeccion") + ": " + rs.getString("tituloLeccion") + "</h3>");
                            out.println("</div>");
                            out.println("</div>");
                        }
                    }
                    ...
                    out.println("<p>Error al cargar las lecciones: " + e.getMessage() + "</p>");
                } finally {
                    if (rs != null) try {
                        rs.close();
        ...
        <div class="curso" onclick="window.location.href = 'eleccionPlantillas.jsp'">

            <div class="prompt-extrabold" style="font-size: 25px;">
                <img class="imagenCurso2" src="imagenes/add_70dp_5F6368_FILL0_wght300_GRAD200_opsz48.png"  alt="alt"/>
            </div>
