    ...
    <body>
        <div class="Header">
            ...
            <%
                ...
                try {
                    bd.conectar();
                    String query = "SELECT c.idCurso, c.nombreCurso, c.descripcion, c.categoria, p.image, c.publico "
                    ...
                    while (rs.next()) {
                        ...
                        out.println("<p><strong>Publico:</strong> " + publico + "</p>");
                        out.println("<a href='detallesCurso.jsp?idCurso=" + idCurso + "&linkCurso=" + java.net.URLEncoder.encode(nombreCurso, "UTF-8") + "'>Ver Detalles</a>");
                        out.println("<br>");
                        out.println("<a href='publicarCurso.jsp?idCurso=" + idCurso + "&linkCurso=" + java.net.URLEncoder.encode(nombreCurso, "UTF-8") + "'>Publicar</a>");
                        out.println("<br>");
                        out.println("<a href='eliminarCurso.jsp?idCurso=" + idCurso + "&linkCurso=" + java.net.URLEncoder.encode(nombreCurso, "UTF-8") + "'>Eliminar</a>");
                        out.println("</div>");
                    }
                    ...
                    if (!hasCourses) {
                        ...
                        out.println("<p>Parece que no tienes cursos.</p>");
                        out.println("</div>");
                    }
        ...
        <div class="curso" onclick="window.location.href = 'CrearCursos.jsp'">
