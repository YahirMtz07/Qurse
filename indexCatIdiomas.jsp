        ...
        <div class="container-fluid">
            ...
            <nav>          
                ...
                <div class="categorias">
                    ...
                    <div style="background-color: #FF6D00;" class="categoria" onclick="window.location.href = 'indexCatIdiomas.jsp'"><div>Idiomas</div></div>
                ...
                <%
                    ...
                    try {
                        ...
                        String query = "SELECT c.idCurso, c.nombreCurso, c.descripcion, c.categoria, p.image "
                                ...
                                + "LEFT JOIN portadasCursos p ON c.idCurso = p.idCurso where c.publico='si' and c.categoria='Idiomas'";
