        ...
        <div class="container-fluid">
            ...
            <nav>          
                ...
                <div class="categorias">
                    ...
                    <div style="background-color: #FF6D00;"  class="categoria" onclick="window.location.href = 'indexCatCienciasdeDatoseInteligenciaArtificial.jsp'"><div>Ciencias de Datos e Inteligencia Artificial</div></div>
                    ...
                    <div class="categoria" onclick="window.location.href = 'indexCatMúsicayProducciónMusical.jsp'"><div>Música y Producción Musical</div></div>
                ...
                <%
                    ...
                    try {
                        ...
                        String query = "SELECT c.idCurso, c.nombreCurso, c.descripcion, c.categoria, p.image "
                                ...
                                + "LEFT JOIN portadasCursos p ON c.idCurso = p.idCurso where c.publico='si' and c.categoria='Ciencias de Datos e Inteligencia Artificial'";
