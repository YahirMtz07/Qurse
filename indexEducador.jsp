        ...
        <div class="Header">
            ...
            <div style="background-color:#FFD56A;  width: 300px; margin: 0px; " class="offcanvas offcanvas-start" tabindex="-9" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
                ...
                <div class="offcanvas-body"  style=" padding: 0px; margin: 0px;">
                    ...
                    <div class="boton-menu" onclick="window.location.href = 'indexEducador.jsp'">
                        <div>Pagina Principal</div>
                    </div>
                    <div class="boton-menu" onclick="window.location.href = 'MisCursosEducador.jsp'">
                        <div>Mis Cursos</div>
                    </div>
        ...
        <div class="container-fluid">
            ...
            <nav>          
                ...
                <div class="categorias">
                    <div class="categoria" onclick="window.location.href = 'indexEducador.jsp'"><div>Todos</div></div>
                    <div class="categoria" onclick="window.location.href = 'indexEducador.jsp'"><div>Tecnología y Programación</div></div>
                    <div class="categoria" onclick="window.location.href = 'indexEducador.jsp'"><div>Ciencias y Matemáticas</div></div>
                    <div class="categoria" onclick="window.location.href = 'indexEducador.jsp'"><div>Negocios y Emprendimiento</div></div>
                    <div class="categoria" onclick="window.location.href = 'indexEducador.jsp'"><div>Idiomas</div></div>
                    <div class="categoria" onclick="window.location.href = 'indexEducador.jsp'"><div>Artes y Creatividad</div></div>
                    <div class="categoria" onclick="window.location.href = 'indexEducador.jsp'"><div>Salud y Bienestar</div></div>
                    <div class="categoria" onclick="window.location.href = 'indexEducador.jsp'"><div>Ciencias Sociales y Humanidades</div></div>
                    <div class="categoria" onclick="window.location.href = 'indexEducador.jsp'"><div>Desarrollo Personal y Habilidades Blandas</div></div>
                    <div class="categoria" onclick="window.location.href = 'indexEducador.jsp'"><div>Marketing y Publicidad</div></div>
                    <div class="categoria" onclick="window.location.href = 'indexEducador.jsp'"><div>Finanzas y Contabilidad</div></div>
                    <div class="categoria" onclick="window.location.href = 'indexEducador.jsp'"><div>Ciencias de Datos e Inteligencia Artificial</div></div>
                    <div class="categoria" onclick="window.location.href = 'indexEducador.jsp'"><div>Diseño y Multimedia</div></div>
                    <div class="categoria" onclick="window.location.href = 'indexEducador.jsp'"><div>Negocios y Emprendimiento Digital</div></div>
                    <div class="categoria" onclick="window.location.href = 'indexEducador.jsp'"><div>Diseño Web y UX/UI</div></div>
                    <div class="categoria" onclick="window.location.href = 'indexEducador.jsp'"><div>Arte Digital e Ilustración</div></div>
                    <div class="categoria" onclick="window.location.href = 'indexEducador.jsp'"><div>Deportes y Entrenamiento Físico</div></div>
                    <div class="categoria" onclick="window.location.href = 'indexEducador.jsp'"><div>Música y Producción Musical</div></div>
                    <div class="categoria" onclick="window.location.href = 'indexEducador.jsp'"><div>Gastronomía y Hospitalidad</div></div>


                </div>
            </nav>  
            <div>
                <h2 class="prompt-extrabold" style="font-size: 50px; color:#481c00;">Mis Cursos en Qurse</h2>
                ...
                <%
                    ...
                    try {
                       ...
                       String query = "SELECT c.idCurso, c.nombreCurso, c.descripcion, c.categoria, p.image "
                                ...
                                + "LEFT JOIN portadasCursos p ON c.idCurso = p.idCurso where idUser ="+idUser+";";
