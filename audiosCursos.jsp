...
<body>
    ...
    <form method="POST" action="AudioServlet" enctype="multipart/form-data">
        <label for="nombre">Nombre del audio:</label>
        <input type="text" name="nombre" id="nombre" required>

        <label for="audio">Selecciona el archivo de audio:</label>
